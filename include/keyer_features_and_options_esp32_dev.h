...
#undef FEATURE_SIDETONE
#undef FEATURE_SIDETONE_NEWTONE
#undef FEATURE_LCD
#undef FEATURE_LCD_I2C
#undef FEATURE_LCD_4BIT
#undef FEATURE_EEPROM_E24C1024
//#undef FEATURE_BUTTONS        // Wyłącz na chwilę, by sprawdzić czy to nie one blokują
#undef FEATURE_POTENTIOMETER
#undef FEATURE_LCD_ADAFRUIT_I2C
#undef FEATURE_LCD_YDv1
#undef FEATURE_LCD_I2C_FDEBRABANDER
#undef FEATURE_LCD_SAINSMART_I2C
#undef FEATURE_EEPROM_E24C1024
#undef FEATURE_LCD_MATHERTEL_PCF8574
#undef FEATURE_BUTTONS
#undef FEATURE_POTENTIOMETER
#undef FEATURE_ROTARY_ENCODER