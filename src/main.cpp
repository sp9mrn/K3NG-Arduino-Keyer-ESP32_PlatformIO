...
#define eeprom_magic_number 122              // you can change this number to have the unit re-initialize EEPROM
#include <arduino.h>
#include <stdio.h>
#include "keyer_hardware.h"
  ...
  //#include <Tone32.h> // SP5IOU 2021/08/02 library Tone32h assure ESP32 compatibility with avr tone / no tone built in commands. 
                      ...
                      #define tone(...)    // puste, nic nie robi
#define noTone(...)  // puste, nic nie robi
